...
export const AUDIT_ACTIONS = {
  ...
  CASUAL_SWIM_BILL_CREATED: "CASUAL_SWIM_BILL_CREATED",
  CASUAL_SWIM_TICKET_CREATED: "CASUAL_SWIM_TICKET_CREATED",
  CASUAL_SWIM_BILL_DELETED: "CASUAL_SWIM_BILL_DELETED",
  CASUAL_SWIM_TICKET_COUNTER_RESET: "CASUAL_SWIM_TICKET_COUNTER_RESET",
  CASUAL_SWIM_SETTINGS_UPDATED: "CASUAL_SWIM_SETTINGS_UPDATED",
} as const;
