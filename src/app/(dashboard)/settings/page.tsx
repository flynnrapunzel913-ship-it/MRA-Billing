...
export default function SettingsPage() {
  ...
  const onSubmit = async (data: SettingsInput) => {
    ...
    reset({
      ...
      defaultCgstRate: Number(result.data.defaultCgstRate ?? 0),
      defaultSgstRate: Number(result.data.defaultSgstRate ?? 0),
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Upload an S2-19 backup JSON file to replace all current system data.
                </p>
              </div>
              <input
