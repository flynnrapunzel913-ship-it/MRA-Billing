...
import { CustomersDateGroupedList } from "@/components/customers/customers-date-grouped-list";
...
export default function CustomersPage() {
  ...
  const subscriptionOptions = useMemo(() => {
    ...
    return rows
      .map((row) => ({ id: row.id, name: row.planName ?? row.name }))
